...
$translations = array(
    ...
    'ph1' => '4-16 caracteres., sem maiúsculas, 1º deve ser caracter.',

    'ph2' => 'Min. 6 caracteres.',
    ...
    'explanation-5.7' => 'O nome de usuário MySQL e o nome do banco de dados podem contar letras minusculas, numeros e "underline"(sublinhado) e deve ter entre 4 e 16 caracteres. Você não pode utilizar <a href="https://dev.mysql.com/doc/refman/5.7/en/reserved-words.html"> as palavras reservadas (link em inglês)</a>!',
    ...
    'explanation-8.0' => 'O nome de usuario MySQL e o nome do banco de dados podem contar letras minusculas, numeros e "underline"(sublinhado) e deve ter entre 4 e 16 caracteres. Você não pode utilizar <a href="https://dev.mysql.com/doc/refman/8.0/en/reserved-words.html">palavras reservadas(link em inglês)</a>!',
    ...
    'agm-li3' => 'Se você tentar utilizar o seu banco de dados db4free.net para produção final mesmo com os avisos, você faz isso por sua conta e risco (recomendamos que realize backups frequentemente)',
